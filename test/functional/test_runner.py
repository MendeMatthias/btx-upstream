...
EXTENDED_SCRIPTS = [
    ...
    'feature_shieldedv2dev_launch_rehearsal.py',
    'feature_shielded_v2_proof_redteam_campaign.py',
    # BTX: KAWPOW is currently disabled in consensus params; keep coverage categorized,
    # but don't run it as part of the base suite.
    'feature_btx_kawpow_consensus.py',
]
...
BASE_SCRIPTS = [
    ...
    # BTX disables creation of new legacy wallets. Generic current-wallet tests
    # therefore run only against the supported descriptor/P2MR wallet; the
    # createwallet rejection contract is covered by
    # feature_btx_pq_wallet_enforcement.py. Tests dedicated to loading,
    # inspecting, importing, or migrating pre-existing legacy-wallet data
    # remain registered separately for compatibility coverage.
    ...
    'feature_matmul_v4_activation.py',
    'feature_matmul_bmx4c_activation.py',
    ...
    'feature_btx_validation_mode_safety.py --descriptors',
    'feature_validation_epoch_heal.py',
    'feature_issue_116_mmattest_wire.py',
    'feature_btx_pq_wallet_enforcement.py',
    'feature_pq_multisig.py --descriptors',
    'feature_whitelist_noban_guardrails.py',
    'rpc_pq_wallet.py',
    'wallet_shielded_encrypted_persistence.py',
    'wallet_shielded_restart_persistence.py',
    'wallet_shielded_reorg_recovery.py',
    'feature_shielded_prune_reorg.py',
    'wallet_shielded_anchor_window.py',
    'wallet_shielded_ring_size_policy.py',
    'wallet_shielded_chunking.py',
    ...
    'wallet_shielded_replacement.py',
    'wallet_shielded_unlock_rehydrate_autoshield.py',
    'wallet_shielded_postfork_coinbase_autoshield.py',
    'wallet_shielded_autoshield_optin.py',
    'wallet_shielded_sunset_rpc_guards.py',
    'wallet_shielded_velocity_cap.py',
    'wallet_shielded_postfork_privacy.py',
    'wallet_shielded_rpc_surface.py',
    'wallet_shielded_viewingkey_rescan.py',
    'wallet_shielded_psbt.py --descriptors',
    'wallet_shielded_psbt_3of3.py --descriptors',
    'wallet_shielded_transfer_builder.py --descriptors',
    'wallet_shielded_transfer_builder_locks.py --descriptors',
    'wallet_smile_v2_benchmark.py',
    'wallet_smile_v2_full_lifecycle.py',
    'wallet_bridge_egress_build.py',
    'feature_spend_path_recovery_activation_compat.py',
    'feature_spend_path_recovery_reorg.py',
    'rpc_btx_difficulty_health.py',
    'rpc_pq_multisig.py',
    'feature_p2mr_end_to_end.py',
    'p2mr_end_to_end.py',
    'mining_matmul_basic.py',
    'feature_btx_matmul_metal_high_hash_repro.py',
    'p2p_matmul_dos_mitigation.py',
    'p2p_matmul_encdr_sketch_cache.py',
    ...
    'feature_io_errors.py --descriptors',
    'feature_prevoutfetch.py',
    ...
    'wallet_sendall_pq.py',
    'wallet_sweepprivkeys.py',
    'wallet_sweeptoself.py',
    ...
    'wallet_bridge_batch_anchor.py --descriptors',
    'wallet_bridge_batch_receipt.py --descriptors',
    ...
    'wallet_bridge_proof_artifact.py --descriptors',
    'wallet_bridge_aggregate_settlement.py --descriptors',
    'wallet_bridge_aggregate_artifact_bundle.py --descriptors',
    'wallet_bridge_proof_compression_target.py --descriptors',
    'wallet_bridge_capacity_estimate.py --descriptors',
    'wallet_bridge_state_growth.py --descriptors',
    'wallet_bridge_state_retention.py --descriptors',
    'wallet_bridge_prover_capacity.py --descriptors',
    'wallet_bridge_prover_profile.py --descriptors',
    'wallet_bridge_prover_template.py --descriptors',
    'wallet_bridge_prover_benchmark.py --descriptors',
    'wallet_bridge_verifier_set.py --descriptors',
    'wallet_bridge_hybrid_anchor.py --descriptors',
    'wallet_bridge_planout.py --descriptors',
    'wallet_bridge_refund.py --descriptors',
    'wallet_bridge_psbt.py --descriptors',
    'wallet_bridge_pending_recovery.py --descriptors',
    'wallet_bridge_batch_commitment.py --descriptors',
    ...
    'rpc_dumptxoutset.py',
    'feature_shielded_snapshot_retention_profile.py',
    ...
    'feature_help.py',
    'feature_shutdown.py',
    'feature_modelnet_helper.py',
    'feature_modelnet_0348.py',
    'feature_modelnet_0348_ops.py',
    'feature_modelnet_jit_capability.py',
    'feature_modelnet_btx_model.py',
    'feature_modelnet_unique_todos.py',
    'feature_modelnet_hcp.py',
    'feature_modelnet_hcp_journeys.py',
    'feature_modelnet_cr11.py',
    'feature_modelnet_cr11_journeys.py',
    'feature_modelnet_cr12.py',
    'feature_modelnet_cr12_scale.py',
    'feature_modelnet_firstrun.py',
    'feature_modelnet_events.py',
    'feature_modelnet_search.py',
    'feature_modelnet_lan_stampede.py',
    'feature_modelnet_packages.py',
    'feature_modelnet_jit_remaining.py',
    'feature_modelnet_swarm_live.py',
    'feature_hcp_remaining.py',
    'feature_modelnet_minio.py',
    'feature_modelnet_security_r10.py',
    'wallet_modelnet_funding.py --descriptors',
    'wallet_migration.py',
    'p2p_ibd_txrelay.py',
    'p2p_seednode.py',
...
# BTX fork default matrix: user-journey and operational coverage for the
...
BTX_BASE_SCRIPTS = [
    ...
    'wallet_shielded_cross_wallet.py',
    'wallet_shielded_longhaul_sim.py',
    'wallet_shielded_matrict_disable_transition.py',
    'wallet_shielded_topology_sim.py',
    'wallet_shielded_send_flow.py',
    'wallet_shielded_sendmany_stress.py',
    'wallet_shielded_mixed_stress.py',
    ...
    'wallet_shielded_autoshield_optin.py',
    'wallet_shielded_sunset_rpc_guards.py',
    'wallet_shielded_c002_sunset_lifecycle.py',
    'wallet_c002_slh_mempool_boundary.py',
    'wallet_shielded_velocity_cap.py',
    'mining_shielded_exit_velocity_template.py',
    'wallet_shielded_rpc_surface.py',
    'wallet_shielded_viewingkey_rescan.py',
    ...
    'wallet_sweeptoself.py',
    'feature_btx_matmul_consensus.py',
    'feature_shieldedv2dev_datadir_isolation.py',
    'feature_autoupdate_installer.py',
    'feature_btx_block_capacity.py --descriptors',
    'feature_btx_subsidy_schedule.py',
    'feature_btx_fast_mining_phase.py',
    'feature_btx_genesis_readiness.py',
    ...
    'p2p_matmul_handoff_budget_retain.py',
...
NON_SCRIPTS = [
    ...
    "combine_logs.py",
    "create_cache.py",
    "feature_prevoutfetch_benchmark.py",
    "shielded_reference_vectors.py",
    "test_runner.py",
]

def _config_has_built_daemon(config: configparser.ConfigParser) -> bool:
    try:
        build_dir = config["environment"]["BUILDDIR"]
    except KeyError:
        return False
    exeext = config["environment"].get("EXEEXT", "")
    bin_dir = pathlib.Path(build_dir) / "bin"
    return any((bin_dir / binary).is_file() for binary in (f"btxd{exeext}", f"bitcoind{exeext}"))


def _load_config(configfile: str) -> configparser.ConfigParser:
...
def _resolve_configfile(explicit_configfile) -> str:
    if explicit_configfile:
        return os.path.abspath(explicit_configfile)

    test_dir = pathlib.Path(__file__).resolve().parent.parent
    default_configfile = (test_dir / "config.ini").resolve()
    build_configfiles = sorted(test_dir.parent.glob("build*/test/config.ini"))
    preferred_build_configfile = test_dir.parent / "build-btx" / "test" / "config.ini"

    candidates = [default_configfile]
    if preferred_build_configfile in build_configfiles:
        candidates.append(preferred_build_configfile)
        build_configfiles.remove(preferred_build_configfile)
    candidates.extend(build_configfiles)
    ...
    for candidate in candidates:
        ...
        if not candidate.is_file():
            continue
        try:
            config = _load_config(str(candidate))
        except OSError:
            continue
        if _config_has_built_daemon(config):
            return str(candidate)

    return str(default_configfile)
...
def main():
    ...
    parser.add_argument('--configfile', help='Location of the test framework config file (default: auto-detected)')
    ...
    default_configfile = os.path.abspath(os.path.dirname(__file__)) + "/../config.ini"
    ...
    if not args.configfile and os.path.abspath(configfile) != os.path.abspath(default_configfile):
        logging.debug("Auto-selected config file %s instead of default %s", configfile, default_configfile)

    # Create base test directory. Use mkdtemp to avoid collisions when
    # multiple test_runner.py processes start within the same second.
    tmpdir_prefix = "test_runner_₿_🏃_{}_" .format(datetime.datetime.now().strftime("%Y%m%d_%H%M%S"))
    tmpdir = tempfile.mkdtemp(prefix=tmpdir_prefix, dir=args.tmpdirprefix)

    # Avoid collisions with long-lived local nodes by defaulting each runner to
    # a unique high port range unless the caller already set TEST_RUNNER_PORT_MIN.
    if "TEST_RUNNER_PORT_MIN" not in os.environ:
        dynamic_port_min = 20_000 + ((os.getpid() * 97) % 25_000)
        os.environ["TEST_RUNNER_PORT_MIN"] = str(dynamic_port_min)
        logging.debug("Assigned TEST_RUNNER_PORT_MIN=%s", dynamic_port_min)
    ...
    # Build list of tests
    test_list = []
    run_upstream_base_suite = os.getenv("BTX_RUN_UPSTREAM_BASE_SUITE", "0") == "1"
    ...
    if tests:
        ...
        # Opt-in path for broad upstream-style base matrix on BTX fork.
        test_list += BASE_SCRIPTS
    else:
        # Run BTX fork base matrix by default.
        test_list += BTX_BASE_SCRIPTS
...
def run_tests(*, test_list, build_dir, tmpdir, jobs=1, enable_coverage=False, args=None, combined_logs_len=0, failfast=False, use_term_control, keepcache=False, results_filepath=None):
    args = args or []

    # Warn if btxd/bitcoind is already running
    try:
        # pgrep exits with code zero when one or more matching processes found
        if subprocess.run(["pgrep", "-x", "btxd|bitcoind"], stdout=subprocess.DEVNULL).returncode == 0:
            print("%sWARNING!%s There is already a btxd/bitcoind process running on this system. Tests may fail unexpectedly due to resource contention!" % (BOLD[1], BOLD[0]))
    except OSError:
        # pgrep not supported
        pass

    # Use an isolated cache for each runner by default to avoid cross-process races.
    # `--keepcache` explicitly opts into the shared build cache for faster repeated runs.
    cache_dir = ("%s/test/cache" % build_dir) if keepcache else ("%s/cache" % tmpdir)
    if keepcache and os.path.isdir(cache_dir):
    ...
    # Populate cache up front for deterministic behavior, even for single-test runs.
    # This prevents races where concurrent runners observe a partially initialized cache.
    try:
        subprocess.check_output([sys.executable, tests_dir + 'create_cache.py'] + flags + ["--tmpdir=%s/cache_setup" % tmpdir])
...
class TestHandler:
    ...
    def __init__(self, *, num_tests_parallel, tests_dir, tmpdir, test_list, flags, use_term_control):
        ...
        # Make portseed process-unique so independent test_runner.py invocations
        # can run concurrently without RPC/P2P port collisions.
        self.portseed_base = os.getpid() << 8
...
def check_script_prefixes():
    ...
    good_prefixes_re = re.compile("^(example|feature|interface|mempool|mining|p2mr|p2p|rpc|wallet|tool)_")
