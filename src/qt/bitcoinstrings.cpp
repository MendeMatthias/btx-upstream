...
QT_TRANSLATE_NOOP("bitcoin-core", "Error loading %s: csv_multi_pq sequence is not BIP68-valid. Recreate the descriptor with a BIP68 sequence (TYPE_FLAG | MASK only). This is not wallet corruption."),
