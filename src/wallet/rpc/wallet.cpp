...
static RPCHelpMan loadwallet()
{
    return RPCHelpMan{"loadwallet",
                ...
                "\nNote that all wallet command-line options used when starting btxd will be"
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    AddLockedShieldedAccountingWarningIfNeeded(*wallet, warnings, "load");
...
static RPCHelpMan createwallet()
{
    return RPCHelpMan{
        ...
        "\nCreates and loads a new wallet.\n",
        {
            ...
            {"descriptors", RPCArg::Type::BOOL, RPCArg::Default{true}, "Create a native descriptor wallet. On BTX this must be true."},
            {"load_on_startup", RPCArg::Type::BOOL, RPCArg::Optional::OMITTED, "Save wallet name to persistent settings and load on startup. True to add wallet to startup list, false to remove, null to leave unchanged."},
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    const bool descriptors = self.Arg<bool>("descriptors");
    if (!descriptors) {
        throw JSONRPCError(RPC_INVALID_PARAMETER, LEGACY_WALLET_DISABLED_ERROR);
    }
    if (descriptors) {
#ifndef USE_SQLITE
...
static RPCHelpMan createwalletdescriptor()
{
    return RPCHelpMan{"createwalletdescriptor",
        ...
        RPCExamples{
            HelpExampleCli("createwalletdescriptor", "p2mr")
            + HelpExampleRpc("createwalletdescriptor", "p2mr")
        },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
        {
            std::shared_ptr<CWallet> const pwallet = GetWalletForJSONRPCRequest(request);
            ...
            if (*output_type != OutputType::P2MR) {
...
Span<const CRPCCommand> GetWalletRPCCommands()
{
    static const CRPCCommand base[]{
        ...
        {"shielded", &z_fundpsbt},
        {"shielded", &z_finalizepsbt},
        {"shielded", &z_planshieldfunds},
        ...
        {"shielded", &z_listaddresses},
        {"shielded", &z_rotateaddress},
        {"shielded", &z_revokeaddress},
        {"shielded", &z_gettotalbalance},
        {"shielded", &z_listreceivedbyaddress},
        ...
        {"bridge", &bridge_buildproofprofile},
        {"bridge", &bridge_decodeproofprofile},
        {"bridge", &bridge_buildproofclaim},
        {"bridge", &bridge_decodeproofclaim},
        {"bridge", &bridge_listproofadapters},
        {"bridge", &bridge_listprovertemplates},
        {"bridge", &bridge_buildproofadapter},
        {"bridge", &bridge_decodeproofadapter},
        {"bridge", &bridge_buildproofartifact},
        {"bridge", &bridge_decodeproofartifact},
        {"bridge", &bridge_builddataartifact},
        {"bridge", &bridge_decodedataartifact},
        {"bridge", &bridge_buildaggregateartifactbundle},
        {"bridge", &bridge_decodeaggregateartifactbundle},
        {"bridge", &bridge_buildaggregatesettlement},
        {"bridge", &bridge_decodeaggregatesettlement},
        {"bridge", &bridge_buildproofcompressiontarget},
        {"bridge", &bridge_decodeproofcompressiontarget},
        {"bridge", &bridge_buildshieldedstateprofile},
        {"bridge", &bridge_decodeshieldedstateprofile},
        {"bridge", &bridge_buildstateretentionpolicy},
        {"bridge", &bridge_decodestateretentionpolicy},
        {"bridge", &bridge_buildproversample},
        {"bridge", &bridge_decodeproversample},
        {"bridge", &bridge_buildproverprofile},
        {"bridge", &bridge_decodeproverprofile},
        {"bridge", &bridge_buildproverbenchmark},
        {"bridge", &bridge_decodeproverbenchmark},
        {"bridge", &bridge_estimatestategrowth},
        {"bridge", &bridge_estimatestateretention},
        {"bridge", &bridge_estimatecapacity},
        {"bridge", &bridge_buildproofpolicy},
        {"bridge", &bridge_buildbatchstatement},
        {"bridge", &bridge_buildingressstatement},
        {"bridge", &bridge_buildegressstatement},
        {"bridge", &bridge_signbatchreceipt},
        {"bridge", &bridge_decodebatchreceipt},
        {"bridge", &bridge_buildproofreceipt},
        {"bridge", &bridge_buildingressbatchtx},
        {"bridge", &bridge_buildegressbatchtx},
        {"bridge", &bridge_decodeproofreceipt},
        {"bridge", &bridge_buildproofanchor},
        {"bridge", &bridge_buildhybridanchor},
        {"bridge", &bridge_buildexternalanchor},
        {"bridge", &bridge_signbatchauthorization},
        {"bridge", &bridge_decodebatchauthorization},
        {"bridge", &bridge_buildbatchcommitment},
        {"bridge", &bridge_decodebatchcommitment},
        {"bridge", &bridge_buildshieldtx},
        {"bridge", &bridge_submitrebalancetx},
