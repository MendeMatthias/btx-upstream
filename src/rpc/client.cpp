...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "clearmintedattestation", 0, "height" },
    { "clearmintedattestation", 1, "end_height" },
    ...
    { "bridge_buildshieldtx", 4, "options" },
    { "bridge_submitshieldtx", 2, "vout" },
    { "bridge_submitshieldtx", 3, "amount" },
    { "bridge_submitshieldtx", 4, "options" },
    { "bridge_buildunshieldtx", 2, "vout" },
    { "bridge_buildunshieldtx", 3, "amount" },
    { "bridge_buildunshieldtx", 4, "options" },
    { "bridge_submitunshieldtx", 2, "vout" },
    { "bridge_submitunshieldtx", 3, "amount" },
    { "bridge_submitunshieldtx", 4, "options" },
    { "bridge_submitrebalancetx", 0, "reserve_deltas" },
    { "bridge_submitrebalancetx", 1, "reserve_outputs" },
    { "bridge_submitrebalancetx", 2, "options" },
    { "bridge_importpending", 2, "vout" },
    { "bridge_importpending", 3, "amount" },
    { "bridge_importpending", 4, "options" },
    { "bridge_listarchive", 0, "options" },
    { "bridge_recoverpending", 1, "vout" },
    { "bridge_recoverpending", 2, "force" },
    { "bridge_prunearchive", 0, "options" },
    { "bridge_buildrefund", 2, "vout" },
    { "bridge_buildrefund", 3, "amount" },
    { "bridge_buildrefund", 5, "fee" },
    { "bridge_buildrefund", 6, "enforce_timeout" },
    { "buildhtlcclaim", 1, "prevout" },
    { "buildhtlcclaim", 4, "fee" },
    { "buildhtlcrefund", 1, "prevout" },
    { "buildhtlcrefund", 3, "locktime" },
    { "buildhtlcrefund", 4, "fee" },
    { "buildhtlcrefund", 5, "allow_non_htlc_tree" },
    { "importmulti", 0, "requests" },
    { "importmulti", 1, "options" },
    { "importmulti", 1, "rescan" },
    { "importdescriptors", 0, "requests" },
    { "importdescriptors", 1, "seeds" },
    { "deriveexchangeaddress", 0, "index" },
    { "deriveexchangeaddress", 1, "options" },
    { "importdepositpool", 0, "entries" },
    { "importdepositpool", 1, "options" },
    { "prepareexternalsign", 0, "package" },
    { "prepareexternalsign", 1, "options" },
    { "getsigningdigests", 0, "package" },
    { "finalizeexternalsign", 0, "package" },
    { "finalizeexternalsign", 1, "signatures" },
    { "finalizeexternalsign", 2, "options" },
    { "getdepositstatus", 1, "vout" },
    { "listdepositutxos", 0, "options" },
    { "planconsolidation", 0, "options" },
    { "createconsolidationtx", 0, "change_address", /*also_string=*/true },
    { "createconsolidationtx", 1, "options" },
    { "estimateconsolidationfee", 0, "options" },
    { "createexchangebatch", 0, "outputs" },
    { "createexchangebatch", 1, "options" },
    ...
    { "addminingpeermeshnode", 1, "persistent" },
    { "addminingpeermeshnode", 2, "try_now" },
    { "addminingpeermeshnode", 3, "v2transport" },
    { "removeminingpeermeshnode", 1, "disconnect" },
    { "refreshminingpeermesh", 0, "include_defaults" },
    { "refreshminingpeermesh", 1, "include_added" },
    { "refreshminingpeermesh", 2, "v2transport" },
    { "addconnection", 2, "v2transport" },
    { "listmempooltransactions", 0, "start_sequence"},
    { "listmempooltransactions", 1, "verbose"},
    { "setresourcegovernorpolicy", 0, "policy" },
    { "pausebackgroundwork", 0, "duration" },
    { "searchmodels", 0, "query" },
    { "publishmodelsearchrecord", 1, "metadata" },
    { "updatemodelsearchrecord", 1, "patch" },
    { "listmodelsearchrecords", 0, "query" },
    { "getmodeldirectory", 0, "query" },
    { "searchpublishers", 0, "query" },
    { "searchcollections", 0, "query" },
    { "browsemodels", 0, "query" },
    { "gettrendingmodels", 0, "query" },
    { "getsimilarmodels", 0, "query" },
    { "getnewmodels", 0, "query" },
    { "getrecentreleases", 0, "query" },
    { "addmodelindex", 0, "endpoint" },
    { "removemodelindex", 0, "endpoint" },
    ...
    { "getmodel", 1, "mode", /*also_string=*/true },
    { "setmodelpolicy", 0, "policy" },
    { "importmodelcontacts", 0, "peers" },
    { "importmodelpeers", 0, "peers" },
    { "importmodeltrust", 0, "peers" },
    { "setmodelrule", 0, "rule" },
    { "removemodelrule", 0, "index" },
    { "delegatemodelservice", 0, "body" },
    { "revokemodelservice", 0, "body" },
    { "preparemodelfunding", 0, "release_id", /*also_string=*/true },
    { "preparemodelfunding", 1, "options" },
    { "signmodelfunding", 1, "options" },
    ...
    { "executemodelimport", 0, "request" },
    { "getmodelimport", 0, "request" },
    { "cancelmodelimport", 0, "request" },
    { "resumemodelimport", 0, "request" },
    { "publishmodelimport", 0, "request" },
    { "createbtxpackage", 0, "request" },
    { "inspectbtxpackage", 0, "request" },
    { "verifybtxpackage", 0, "request" },
    { "importbtxpackage", 0, "request" },
    { "exportbtxbundle", 0, "request" },
    { "exportbtxpackage", 0, "request" },
    { "createsubscriptionmandate", 0, "request" },
    { "getsubscriptionmandate", 0, "request" },
    { "getsubscriptionactivity", 0, "request" },
    { "revokesubscriptionmandate", 0, "request" },
    { "reservesubscriptionmandate", 0, "request" },
    { "listmodelidentities", 0, "request" },
    { "createmodelidentity", 0, "label" },
    { "getbtxpackagedocument", 0, "request" },
    { "getbtxpackagecapabilities", 0, "request" },
    { "planbtxacquisition", 0, "request" },
    { "executebtxacquisition", 0, "request" },
    { "getbtxacquisition", 0, "request" },
    { "cancelbtxacquisition", 0, "request" },
    { "planbtxclientinstall", 0, "request" },
    { "planbtxruntime", 0, "request" },
    { "resolvebtxcapability", 0, "request" },
    { "planbtxcapability", 0, "request" },
    { "ensurebtxcapability", 0, "request" },
    { "getbtxcapability", 0, "request" },
    { "cancelbtxcapability", 0, "request" },
    { "releasebtxcapability", 0, "request" },
    { "prefetchbtxcapability", 0, "request" },
    { "sleepbtxcapability", 0, "request" },
    { "wakebtxcapability", 0, "request" },
    { "getbtxresidency", 0, "request" },
    { "inspectbtxtensormap", 0, "request" },
    { "exportbtxlock", 0, "request" },
    { "importbtxlock", 0, "request" },
    { "planbtxcapabilityupdate", 0, "request" },
    { "switchbtxcapability", 0, "request" },
    { "getbtxcapabilityevents", 0, "request" },
    { "getbtxruntimecapabilities", 0, "request" },
    { "getbtxttctrace", 0, "request" },
    { "accepthcphandoff", 0, "request" },
    { "enrollhcpprovider", 0, "request" },
    { "previewhcpprovider", 0, "request" },
    { "sethcplocalgrant", 0, "request" },
    { "gethcpreadiness", 0, "request" },
    { "exporthcpstate", 0, "request" },
    { "importhcpstate", 0, "request" },
    { "sethcpreporting", 0, "request" },
    { "hcphandle", 0, "request" },
    { "pairhcpdevice", 0, "request" },
    { "revokehcpdevice", 0, "request" },
    { "gethcpconnectorstatus", 0, "request" },
    { "applyhcpwalletless", 0, "request" },
    { "hcphealth", 0, "request" },
    { "planhcplocal", 0, "request" },
    { "seedlabmodelchannel", 0, "request" },
    { "puthcplocalitysources", 0, "request" },
    { "minthcphandoff", 0, "request" },
    { "ensurehcplocal", 0, "request" },
    { "preparemodelerasure", 0, "request" },
    { "executemodelerasure", 0, "request" },
    { "getmodelerasurehealth", 0, "request" },
    { "repairmodel", 0, "request" },
    { "gettorrentsourcestatus", 0, "request" },
    { "getmodeloriginoffer", 0, "request" },
    { "getmodeloriginstatus", 0, "request" },
    { "querymodelsummary", 0, "request" },
    { "reconcilemodelindex", 0, "request" },
    { "getmodelobjectlayout", 0, "request" },
    { "validatesubpiece", 0, "request" },
    { "getmodelbulkstatus", 0, "request" },
    { "getmodelioexecutor", 0, "request" },
    { "getevaluatedtransport", 0, "request" },
    { "addmodelstorage", 0, "request" },
    { "inspectmodelstorage", 0, "request" },
    { "testmodelstorage", 0, "request" },
    { "listmodelstorage", 0, "request" },
    { "getmodelcapabilities", 0, "request" },
    { "getmodeltransfermetrics", 0, "request" },
    { "requestmodelorigin", 0, "request" },
    { "getmodeloriginhealth", 0, "request" },
    { "getmodelmirrorstatus", 0, "request" },
    { "removemodelstorage", 0, "request" },
    { "setmodelstoragepolicy", 0, "request" },
    { "setbootstrapdistributor", 0, "request" },
    { "getbootstrapstatus", 0, "request" },
    { "setmodeluploadpolicy", 0, "request" },
    { "getmodeluploadinfo", 0, "request" },
    { "planmodelstoragemigration", 0, "request" },
    { "executemodelstoragemigration", 0, "request" },
    { "setmodelswarmhealer", 0, "request" },
    { "settorrentsourcepolicy", 0, "request" },
    { "getmodelroutingstatus", 0, "request" },
    { "setmodeldiscoverypolicy", 0, "request" },
    { "getmodelresidency", 0, "request" },
    { "getmodeldedupinfo", 0, "request" },
    { "getmodellandiscovery", 0, "request" },
    { "getmodelfileselection", 0, "request" },
    { "getmultipartjournal", 0, "request" },
    { "getsourcepolicy", 0, "request" },
    { "observebountychain", 0, "request" },
    { "reorgbountychain", 0, "request" },
    { "exportbountyrecovery", 0, "request" },
